...
data_standardized = preprocessing.StandardScaler().fit_transform(numeric_columns)
...
plt.scatter(tsne_results[:, 0], tsne_results[:, 1], c=numeric_columns.iloc[:, -1], cmap='viridis', alpha=0.6)
